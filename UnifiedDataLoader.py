...
def main():
    ...
    # T = [[datetime(2023,3,31,6,0)+timedelta(minutes=15*i) for i in range(7)],
    ...
    #         data_point = DataPointProperties(D[i][j],T[i][j],date_type_info[i],weather_info[i],None,None)
    ...
    #     # 近期历史：90天
    #     his_len = 2
    #     his_date_list = [predict_time - timedelta(days=i) for i in range(his_len, 0, -1)]
